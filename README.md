...
- DNS troubleshooting and browser behavior (DoH): [Pi-hole DNS + Firefox DoH Bypass](labs/networking/2026-01-06-firefox-doh-pihole-dns-bypass.md)
- Windows Server file share access and user workflows: [Windows Server File Share + Map Network Drive](labs/windows/2026-01-06-windows-server-file-share-map-drive.md)
- Linux and SSH operations: [GitHub SSH setup on Linux Mint](labs/linux/2026-01-01-github-ssh-setup.md)
